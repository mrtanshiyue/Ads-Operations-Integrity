-- Productization / advisory review workflow.
-- Review state is intentionally separate from optimization-action execution governance.
-- Source evidence is immutable and every record remains non-authoritative for Amazon mutation.
...
CREATE TABLE advisory_review_records (
  ...
  state TEXT NOT NULL DEFAULT 'open'
    CHECK (state IN ('open','acknowledged','dismissed','snoozed')),
