...
if (nativeIndex.indexOf(csvHistoryYearOverYearYtdReviewBoardTag) > nativeIndex.indexOf(csvHistoryComparisonReceiptTag)) throw new Error('CSV historical comparison receipt must load after YoY YTD review board');
