...
if (nativeIndex.indexOf(csvHistoryYearOverYearYtdComparisonTag) > nativeIndex.indexOf(csvHistoryComparisonReceiptTag)) throw new Error('CSV historical comparison receipt must load after YoY YTD comparison');
