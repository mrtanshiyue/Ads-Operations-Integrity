...
if (nativeIndex.indexOf(csvJointAnalysisTag) > nativeIndex.indexOf(csvProductUiTag)) throw new Error('CSV product UI integration must load after Joint CSV Analysis');
