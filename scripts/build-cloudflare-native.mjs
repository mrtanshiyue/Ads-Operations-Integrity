...
for (const [tag, label] of [
  ...
  [csvPeriodUiTag, 'CSV period UI extension'], [csvProvenanceAuditTag, 'CSV provenance audit extension'],
...
if (nativeIndex.indexOf(csvPeriodUiTag) > nativeIndex.indexOf(csvProvenanceAuditTag)) throw new Error('CSV provenance audit UI must load after CSV period UI');
