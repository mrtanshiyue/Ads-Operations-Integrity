...
const allowedAssets = new Set([
  ...
  'cloudflare-native-csv-history-quarter-over-quarter-comparison-impl-v1.js',
  'cloudflare-native-csv-history-quarter-over-quarter-comparison-receipt-v1.js',
  'cloudflare-native-csv-history-quarter-over-quarter-comparison-receipt-impl-v1.js',
  ...
  'cloudflare-native-csv-history-year-to-date-operating-review-impl-v1.js',
  'cloudflare-native-csv-history-year-over-year-ytd-comparison-v1.js',
  'cloudflare-native-csv-history-year-over-year-ytd-comparison-impl-v1.js',
  ...
  'cloudflare-native-csv-history-rolling-12-operating-review-impl-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-review-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-review-impl-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-receipt-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-receipt-impl-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-receipt-verification-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-receipt-verification-impl-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-review-board-v1.js',
  'cloudflare-native-csv-history-rolling-12-window-transition-review-board-impl-v1.js',
  ...
  'cloudflare-native-csv-history-comparison-receipt-verification-impl-v1.js',
