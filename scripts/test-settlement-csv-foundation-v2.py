...
def main():
    ...
    try:
        ...
        ''', (
            ...
            SHA,10,'settlement-csv-import-v1',1,1,0,'unique','validated','{}','2026-08-19T10:00:00Z',
        ))
        raise AssertionError('missing source object was accepted')
    except sqlite3.IntegrityError as exc:
        assert 'SETTLEMENT_SOURCE_OBJECT_REQUIRED' in str(exc), str(exc)
    ...
    expect_integrity(conn,
      "UPDATE settlement_import_batches SET status='published',published_at='2026-08-19T10:01:00Z' WHERE import_id='imp-1'",
