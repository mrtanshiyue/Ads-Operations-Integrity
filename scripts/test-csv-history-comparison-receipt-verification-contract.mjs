...
assert.equal(packageIndexA.packages.some((item) => Object.hasOwn(item, 'sourceFileName')), false, 'Local source filenames must not enter deterministic package entries');
